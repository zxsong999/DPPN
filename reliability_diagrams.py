...
def _reliability_diagram_combined(config,bin_data, 
    ...
    plt.savefig("./figure/"+str(config.dataset)+"_"+str(config.imb_factor)+"_Reliability_diagrams.png")
    # plt.show()

    if return_fig: return fig


def reliability_diagram(config,true_labels, pred_labels, confidences, num_bins=10,
    ...
    return _reliability_diagram_combined(config,bin_data, draw_ece, draw_bin_importance,
